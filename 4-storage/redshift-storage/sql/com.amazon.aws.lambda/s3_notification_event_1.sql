...
CREATE TABLE IF NOT EXISTS atomic.com_amazon_aws_lambda_s3_notification_event_1 (
    ...
    "s3.object.size"                        VARCHAR(4096) ENCODE LZO,
...
COMMENT ON TABLE com_amazon_aws_lambda_s3_notification_event_1 IS 'iglu:com.amazon.aws.lambda/s3_notification_event/jsonschema/1-0-0';
